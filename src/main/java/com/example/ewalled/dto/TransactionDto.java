...
public class TransactionDto {
    ...
    public record Response(String transactionId, LocalDateTime createdAt, String type, String fromto, String description, int amount, String inout, String accountTo, String accountFrom) { }
}
